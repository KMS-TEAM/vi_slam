...
#ifndef VI_SLAM_EPIPOLAR_GEOMETRY_H
#define VI_SLAM_EPIPOLAR_GEOMETRY_H
...
namespace vi_slam{
    namespace geometry{
        ...
        void estiMotionByEssential(
                ...
                vector<int> &inliers_index     // the inlier used in estimating Essential
        );
        /**
        ...
        */
         ...
         * @param pts_on_np1
         * @param pts_on_np2
         * @param R_cam2_to_cam1
         * @param t_cam2_to_cam1
         * @param inliers
...
#endif //VI_SLAM_EPIPOLAR_GEOMETRY_H
