...
namespace vi_slam{
    ...
    namespace geometry{
        ...
        public:
            ...
            int SearchByProjection(datastructures::Frame &F,
                                   const std::vector<datastructures::MapPoint*> &vpMapPoints,
                                   const float th=3);

            // Project MapPoints tracked in last frame into the current frame and search matches.
            // Used to track from previous frame (Tracking)
            int SearchByProjection(datastructures::Frame &CurrentFrame,
                                   const datastructures::Frame &LastFrame,
            ...
            int SearchByProjection(datastructures::KeyFrame* pKF, cv::Mat Scw,
                                   const std::vector<datastructures::MapPoint*> &vpPoints,
                                   std::vector<datastructures::MapPoint*> &vpMatched, int th);

            // Search matches between MapPoints in a KeyFrame and ORB in a Frame.
            // Brute force constrained to ORB that belong to the same vocabulary node (at a certain level)
            // Used in Relocalisation and Loop Detection
            int SearchByBoW(datastructures::KeyFrame *pKF,
                            datastructures::Frame &F,
                            std::vector<datastructures::MapPoint*> &vpMapPointMatches);

            int SearchByBoW(datastructures::KeyFrame *pKF1,
                            datastructures::KeyFrame* pKF2,
                            std::vector<datastructures::MapPoint*> &vpMatches12);

            // Matching for the Map Initialization (only used in the monocular case)
            int SearchForInitialization(datastructures::Frame &F1,
            ...
            int SearchForTriangulation(datastructures::KeyFrame *pKF1,
                                       datastructures::KeyFrame* pKF2,
                                       cv::Mat F12,
            ...
            int SearchBySim3(datastructures::KeyFrame* pKF1,
                             datastructures::KeyFrame* pKF2,
                             std::vector<datastructures::MapPoint *> &vpMatches12,
            ...
            int Fuse(datastructures::KeyFrame* pKF,
                     const vector<datastructures::MapPoint *> &vpMapPoints,
                     const float th=3.0);
            ...
            int Fuse(datastructures::KeyFrame* pKF,
                     cv::Mat Scw,
                     const std::vector<datastructures::MapPoint*> &vpPoints,
                     float th, vector<datastructures::MapPoint *> &vpReplacePoint);
