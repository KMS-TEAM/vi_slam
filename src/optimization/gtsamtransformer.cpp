...
namespace vi_slam {
    namespace optimization{
        ...
        void GtsamTransformer::addMonoMeasurement(vi_slam::datastructures::KeyFrame *pKF,
        ...
        void GtsamTransformer::addStereoMeasurement(vi_slam::datastructures::KeyFrame *pKF,
                                                    vi_slam::datastructures::MapPoint *pMP,
        ...
        gtsam::NonlinearFactorGraph GtsamTransformer::createFactorGraph(map<pair<gtsam::Key, gtsam::Key>,
                pair<string, vi_slam::optimization::GtsamTransformer::FactorType>> ser_factors_map,
                                                                        bool is_incremental) {
        ...
        map<pair<gtsam::Key, gtsam::Key>, pair<string, GtsamTransformer::FactorType>> GtsamTransformer::getDifferenceSet(map<pair<gtsam::Key, gtsam::Key>,
                pair<string,
                        vi_slam::optimization::GtsamTransformer::FactorType>> &set_A,
                                                                                                                         map<pair<gtsam::Key, gtsam::Key>,
                                                                                                                                 pair<string,
                                                                                                                                         vi_slam::optimization::GtsamTransformer::FactorType>> &set_B) {
        ...
        void GtsamTransformer::transformGraphToGtsam(const vector<vi_slam::datastructures::KeyFrame *> &vpKFs, const vector<vi_slam::datastructures::MapPoint *> &vpMP) {
            if (!start())
                return;
        ...
        void GtsamTransformer::updateKeyFrame(vi_slam::datastructures::KeyFrame *pKF, bool add_between_factor) {
        ...
        void GtsamTransformer::updateLandmark(vi_slam::datastructures::MapPoint *pMP) {
        ...
        void GtsamTransformer::updateObservations(MapPoint *pMP, const map<vi_slam::datastructures::KeyFrame *, size_t> &observations) {
        ...
        void GtsamTransformer::setUpdateType(const vi_slam::optimization::GtsamTransformer::UpdateType update_type) {
