...
#include "vi_slam/optimization/sim3solver.h"
...
namespace vi_slam{
    namespace core{
        ...
        bool LoopClosing::ComputeSim3()
        {
            ...
            vector<optimization::Sim3Solver*> vpSim3Solvers;
            ...
            for(int i=0; i<nInitialCandidates; i++)
            {
                ...
                {
                    optimization::Sim3Solver* pSolver = new optimization::Sim3Solver(mpCurrentKF,pKF,vvpMapPointMatches[i],mbFixScale);
            ...
            while(nCandidates>0 && !bMatch)
            {
                for(int i=0; i<nInitialCandidates; i++)
                {
                    ...
                    optimization::Sim3Solver* pSolver = vpSim3Solvers[i];
        ...
        void LoopClosing::CorrectLoop()
        {
            ...
            // Optimize graph
            optimization::Optimizer::OptimizeEssentialGraph(mpMap, mpMatchedKF, mpCurrentKF, NonCorrectedSim3, CorrectedSim3, LoopConnections, mbFixScale);
