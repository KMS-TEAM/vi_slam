...
namespace vi_slam{
    namespace core{
                ...
                mpFrameDrawer(pFrameDrawer), mpMapDrawer(pMapDrawer)
        {
            ...
            mpORBextractorLeft = new geometry::FExtractor(nFeatures,fScaleFactor,nLevels,fIniThFAST,fMinThFAST);

            if(sensor==System::STEREO)
                mpORBextractorRight = new geometry::FExtractor(nFeatures,fScaleFactor,nLevels,fIniThFAST,fMinThFAST);

            if(sensor==System::MONOCULAR)
                mpIniORBextractor = new geometry::FExtractor(2*nFeatures,fScaleFactor,nLevels,fIniThFAST,fMinThFAST);
        ...
        cv::Mat Tracking::GrabImageStereo(const cv::Mat &imRectLeft, const cv::Mat &imRectRight, const double &timestamp)
        {
            ...
            mCurrentFrame = datastructures::Frame(mImGray,imGrayRight,timestamp,mpORBextractorLeft,mpORBextractorRight,mpORBVocabulary,mK,mDistCoef,mbf,mThDepth);
