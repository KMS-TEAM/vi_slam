...
namespace vi_slam{
    namespace geometry{
        long unsigned int Camera::nNextId=0;
        ...
        bool Pinhole::epipolarConstrain(Camera* pCamera2,  const cv::KeyPoint &kp1, const cv::KeyPoint &kp2, const cv::Mat &R12, const cv::Mat &t12, const float sigmaLevel, const float unc) {
        ...
        bool Pinhole::epipolarConstrain_(Camera *pCamera2, const cv::KeyPoint &kp1, const cv::KeyPoint &kp2, const cv::Matx33f &R12, const cv::Matx31f &t12, const float sigmaLevel, const float unc) {
            //Compute Fundamental Matrix
